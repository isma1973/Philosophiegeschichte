...
Mit **69 dynamisch gerenderten Philosophenprofilen**, 10 Epochenmodulen, einer interaktiven
...
- **Datengetriebene Profile:** 69 Philosophenprofile, zentral in `PHILOSOPHERS[]` gepflegt. Jede Profilseite identifiziert den Philosophen per URL und rendert den Inhalt dynamisch in leere HTML‑Container.
...
│   ├── 20jh.html
│   ├── gegenwart.html
│   └── [name].html              # Einzelne Philosophenprofile (69 Dateien)
├── assets/
...
│       ├── philosopher-profile.js  # Zentrale Datenbank (69 Profile) & Templating (68 KB)
...
Das Herzstück des Projekts: **68 KB** zentrale Datenbank mit allen 69 Philosophenprofilen im Array `PHILOSOPHERS[]`. Jede Profilseite ist ein leeres HTML‑Gerüst. Beim Laden identifiziert das Modul den passenden Eintrag über den Dateinamen und füllt alle Felder dynamisch — kein doppelter HTML‑Code.
...
- **Daten‑Architektur:** Ein zentrales JS‑Array als Datenquelle für alle 69 Profile — kein doppelter HTML‑Code.
